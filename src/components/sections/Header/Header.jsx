...
function Header() {
    ...
    return (
        <header className="bg-white">
            <div className="w-full mx-auto max-w-[1170px] flex pt-[23px] pb-[27px] xl:px-0 px-4 justify-between items-center">
                ...
                <div className={`xl:hidden mobile-menu z-10 ${isMenuOpen ? "menu-active" : ""}`}>
                    <nav>
                ...
                <button onClick={toggleMenu} aria-label="Menu" className={`xl:hidden relative z-10 w-8 h-6 flex flex-col justify-between group ${isMenuOpen ? "active" : ""}`}>
